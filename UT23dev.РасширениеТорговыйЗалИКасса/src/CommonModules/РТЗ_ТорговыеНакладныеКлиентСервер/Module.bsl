...
Функция СформироватьНакладныеПоСкладамЧекККМ(Документ) Экспорт
	...
	ТаблицаРезультат = ПолучитьШаблонТаблицыЗначенийРезультат();
	
	Для Каждого СкладСсылка Из Склады Цикл
		
		СтрокаРезультат = ТаблицаРезультат.Добавить();
		СтрокаРезультат.Товар = ПолучитьШаблонТаблицыЗначенийНоменклатуры();
...
// * Количество - Число -
Функция ПолучитьШаблонТаблицыЗначенийНоменклатуры()
...
// * Склад - СправочникСсылка.Склады -
// * Товар - ТаблицаЗначений -
Функция ПолучитьШаблонТаблицыЗначенийРезультат()
